...
<div id="lista_usuarios" class="w3-margin">
    ...
    <form id="form-inscricao" class="form-signin" method="post">
        ...
        <div>
            <label>Nome</label>
            <input type="text" class="w3-input w3-block w3-border" name="NOME_COMPLETO" value="<?php echo $data['NOME_COMPLETO']?>">
        </div>

        <div>
            <label>Login</label>
            <input type="text" class="w3-input w3-block w3-border" name="LOGIN" value="<?php echo $data['LOGIN']?>">
        </div>

        <div>
            <label>Senha</label>
            <input type="password" class="w3-input w3-block w3-border" name="SENHA" value="<?php echo $data['SENHA']?>">
        </div>
        ...
        <div>
            ...
            <a href="<?= \base_url('/Article/listArticle') ?>"><button class="btn btn-outline-info btn-lg" type="button">voltar</button></a>
        </div>
    </form>
