...
<div id="lista_usuarios" class="w3-margin">
    ...
    <h2>Cadastro de Artigos de Tecnologia</h2>

    <?php if (isset($validation)) : ?>
    <div class="alert alert-danger"><?= $validation->listErrors() ?></div>
    <?php endif; ?>
    <form id="form-inscricao" method="POST" action="../Article/saveArticle">
        <div>
            <label>Nome</label>
        ...
        <div>
            <label>Link</label>
            <input type="text" class="w3-input w3-block w3-border" name="LINK">
        </div>
