...
$routes->match(['get','post'],'/saveArticle', 'Article::saveArticle');
$routes->match(['get','post'],'/listArticle', 'Article::listArticle');
$routes->get('successArticle', 'Article::successArticle');
$routes->get('deleteArticle', 'Article::deleteArticle');
